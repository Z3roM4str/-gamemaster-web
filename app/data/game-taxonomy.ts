...
export const gameTaxonomy: Record<string, GameTaxonomySeed> = {
  ...
  fortnite: { genres: ['Acción', 'Shooter'], features: ['Multijugador'], confidence: 'media', reviewNote: 'Servicio vivo: sus modos y énfasis editoriales pueden cambiar con el tiempo.', manualReview: true },
  ...
  'resident-evil-9-requiem-8-7': { genres: ['Acción', 'Shooter', 'Terror y supervivencia'], worlds: ['Resident Evil'], confidence: 'baja', reviewNote: 'El registro agrupa Requiem, Village y Biohazard; conviene decidir si debe separarse en fichas individuales.', manualReview: true },
  ...
  'super-smash-bros-ultimate-pase-de-expansion': { genres: ['Pelea', 'Fiesta'], worlds: ['Super Smash Bros.', 'Nintendo'], features: ['Multijugador', 'Familiar'] },
  ...
  'fire-emblem-engage-expansion-pass': { genres: ['RPG/JRPG', 'Estrategia y táctica'], worlds: ['Fire Emblem', 'Nintendo'], features: ['Aventura larga', 'Desafiante'] },
  ...
  'xenoblade-chronicles-2-expansion-pass': { genres: ['Acción', 'Aventura', 'RPG/JRPG'], worlds: ['Xenoblade Chronicles', 'Nintendo'], features: ['Mundo abierto', 'Exploración', 'Aventura larga'] },
  ...
  'the-legend-of-zelda-breath-of-the-wild-pase-de-expansion': { genres: ['Acción', 'Aventura'], worlds: ['Zelda', 'Nintendo'], features: ['Mundo abierto', 'Exploración', 'Aventura larga'] },
  ...
  'the-legend-of-zelda-tears-of-the-kingdom-pase-de-expansion': { genres: ['Acción', 'Aventura'], worlds: ['Zelda', 'Nintendo'], features: ['Mundo abierto', 'Exploración', 'Aventura larga'], confidence: 'baja', reviewNote: 'El nombre fuente menciona un pase de expansión; conviene validar comercialmente este registro sin alterar el dato histórico.', manualReview: true },
};
